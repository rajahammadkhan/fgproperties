<script type="text/javascript">
    $(document).ready(function() {
      ...
      var table = $('#homeSectionDatatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('home_section_one.datatable') }}",
          "columns": [{
                  "data": "id",
                  "defaultContent": ""
              },
          ...
          "columnDefs": [{
                    ...
                    var checked = row.status == 1 ? 'checked' : null;
                      ...
                      <div class="text-center">
                        <label class="switch s-icons s-outline  s-outline-success  mt-3">
                          <input class="section-one-status" type="checkbox"  ` + checked + ` value="` + row.id + `">
              ...
              },
              {
                  ...
                  "render": function(data, type, row, meta) {
                      ...
                      var edit = "{{ route('home_section_one.edit', [':id']) }}";
                      ...
                      return `<div class="text-center">
                            ...
                            <a href="javascript:void(0);" class="section-one-delete" data-toggle="tooltip" data-placement="top" title="Delete" data-id="`+ data + `">
          ...
          $('.section-one-status').change(function () {
            var $this = $(this);
            var id = $this.val();
            ...
            axios
              .post('{{route("home_section_one.status")}}', {
                _token: '{{csrf_token()}}',
                _method: 'patch',
                id: id,
                status: status,
          ...
          $('.section-one-delete').click(function () {
            ...
            swal({
              ...
              if (result.value) {
              axios
                .post('{{route("home_section_one.destroy")}}', {
                  _method: 'delete',
                  _token: '{{csrf_token()}}',
                  deleteId: deleteId,
                })
