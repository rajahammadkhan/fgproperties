                ...
                <form action="{{ $isEdit ? route('home_section_six.update', [$home_section_six->id]) : route('home_section_six.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="col-md-2">
                                <label>Image <small> (Dimensions : 50 x 50) </small> <span class="text-danger"> *</span> </label>
                                <input {{!$isEdit ? 'required' : null}} type="file" name="image"  class="file" accept="image/*" >
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$home_section_six->image_one ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                    @if ($errors->has('icon'))
                            ...
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name" value="{{ $home_section_six->heading_one ?? old('name') ?? null }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="from" value="{{ $home_section_six->heading_two ?? old('from') ?? null }}"
                                    ...
                                    <div class="col-md-12 mt10">
                                        ...
                                        <textarea name="message" class="form-control" required>{{ $home_section_six->description_one ?? old('message') ?? null }}</textarea>
