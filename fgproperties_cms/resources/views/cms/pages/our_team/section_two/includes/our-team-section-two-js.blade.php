<script type="text/javascript">
    $(document).ready(function() {
      ...
      var table = $('#ourTeamSectionTwoDatatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('our_team_section_two.datatable') }}",
          "columns": [{
                  "data": "id",
                  "defaultContent": ""
              },
          ...
          "columnDefs": [{
                    ...
                    var checked = row.status == 1 ? 'checked' : null;
                      ...
                      <div class="text-center">
                        <label class="switch s-icons s-outline  s-outline-success  mt-3">
                          <input class="section-two-status" type="checkbox"  ` + checked + ` value="` + row.id + `">
              ...
              },
              {
                  ...
                  "render": function(data, type, row, meta) {
                      ...
                      var edit = "{{ route('our_team_section_two.edit', [':id']) }}";
                      ...
                      return `<div class="text-center">
                            ...
                            <a href="javascript:void(0);" class="section-two-delete" data-toggle="tooltip" data-placement="top" title="Delete" data-id="`+ data + `">
          ...
          $('.section-two-status').change(function () {
            var $this = $(this);
            var id = $this.val();
            ...
            axios
              .post('{{route("our_team_section_two.status")}}', {
                _token: '{{csrf_token()}}',
                _method: 'patch',
                id: id,
                status: status,
          ...
          $('.section-two-delete').click(function () {
            ...
            swal({
              ...
              if (result.value) {
              axios
                .post('{{route("our_team_section_two.destroy")}}', {
                  _method: 'delete',
                  _token: '{{csrf_token()}}',
                  deleteId: deleteId,
                })
