<script type="text/javascript">
    $(document).ready(function() {
      ...
      var table = $('#ourTeamSectionFourDatatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('our_team_section_four.datatable') }}",
          "columns": [{
                  "data": "id",
                  "defaultContent": ""
              },
          ...
          "columnDefs": [{
...

              {
                  "targets": 1,
                  "render": function(data, type, row, meta) {
                      return `<img src="{{url('')}}/uploads/${data}" width="60px" height="50px">`; 
                  },
              },
                    ...
                    var checked = row.status == 1 ? 'checked' : null;
                      ...
                      <div class="text-center">
                        <label class="switch s-icons s-outline  s-outline-success  mt-3">
                          <input class="section-four-status" type="checkbox"  ` + checked + ` value="` + row.id + `">
              ...
              },
              {
                  ...
                  "render": function(data, type, row, meta) {
                      ...
                      var edit = "{{ route('our_team_section_four.edit', [':id']) }}";
                      ...
                      return `<div class="text-center">
                            ...
                            <a href="javascript:void(0);" class="section-four-delete" data-toggle="tooltip" data-placement="top" title="Delete" data-id="`+ data + `">
          ...
          $('.section-four-status').change(function () {
            var $this = $(this);
            var id = $this.val();
            ...
            axios
              .post('{{route("our_team_section_four.status")}}', {
                _token: '{{csrf_token()}}',
                _method: 'patch',
                id: id,
                status: status,
          ...
          $('.section-four-delete').click(function () {
            ...
            swal({
              ...
              if (result.value) {
              axios
                .post('{{route("our_team_section_four.destroy")}}', {
                  _method: 'delete',
                  _token: '{{csrf_token()}}',
                  deleteId: deleteId,
                })
