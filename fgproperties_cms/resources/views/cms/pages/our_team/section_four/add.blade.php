        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('other_pages.our_team')}}">Section Four</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{$isEdit ? 'Edit' : 'Add'}}</li>
                </ol>
                
                        
                <form action="{{ $isEdit ? route('our_team_section_four.update', [$our_team_section_four->id]) : route('our_team_section_four.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div style="background: black;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Section Four / {{$isEdit ? 'Edit' : 'Add'}}</h5>
                            </div>
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="col-md-2">
                                ...
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$our_team_section_four->image_one ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                    @if ($errors->has('image'))
                            ...
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="col-md-12 mt10">
                                        ...
                                        <input type="text" name="name" value="{{ $our_team_section_four->heading_one ?? old('name') ?? null }}"
                                    ...
                                    <div class="col-md-12 mt10">
                                        ...
                                        <input type="text" name="designation" value="{{ $our_team_section_four->heading_two ?? old('designation') ?? null }}"
                                    ...
                                    <div class="col-md-4 mt10">
                                        ...
                                        <input type="text" name="twitter_link" value="{{ $our_team_section_four->link_one ?? old('twitter_link') ?? null }}"
                                    ...
                                    <div class="col-md-4 mt10">
                                        ...
                                        <input type="text" name="linkedin_link" value="{{ $our_team_section_four->link_two ?? old('linkedin_link') ?? null }}"
                                    ...
                                    <div class="col-md-4 mt10">
                                        ...
                                        <input type="text" name="facebook_link" value="{{ $our_team_section_four->link_three ?? old('facebook_link') ?? null }}"
