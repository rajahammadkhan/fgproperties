    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <form action="{{ $isEdit ? route('property-management.SectionTwo.update', [$sectionTwo->id]) : route('property-management.SectionTwo.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            <div class="col-md-2">
                                <label>Image <small> (Dimensions : 834 x 834) </small> <span class="text-danger"> *</span> </label>
                                <input {{!$isEdit ? 'required' : null}} type="file" name="image"  class="file" accept="image/*" >
                                <div class="images">
                                    <div class="photo ">
                                        <img src="{{url('')}}/uploads/{{$sectionTwo->image ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                    @if ($errors->has('icon'))
                            ...
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <input type="text" name="heading" value="{{ $sectionTwo->heading ?? old('heading') ?? null }}"
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <input type="text" name="description" value="{{ $sectionTwo->description ?? old('description') ?? null }}"
