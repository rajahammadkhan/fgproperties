<script type="text/javascript">
    $(document).ready(function() {
      ...
      var table = $('#homeSectionThreeDatatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('property-management.SectionTwo.datatable') }}",
          "columns": [{
                  "data": "id",
                  "defaultContent": ""
              },
          ...
          "columnDefs": [{
            ...
            
              {
                  ...
                  "render": function(data, type, row, meta) {
                      ...
                      var edit = "{{ route('property-management.SectionTwo.edit', [':id']) }}";
                      ...
                      return `<div class="text-center">
                            ...
                            <a href="javascript:void(0);" class="section-three-delete" data-toggle="tooltip" data-placement="top" title="Delete" data-id="`+ data + `">
          ...
          $('.section-three-status').change(function () {
            var $this = $(this);
            var id = $this.val();
          ...
          $('.section-three-delete').click(function () {
