<script type="text/javascript">
    $(document).ready(function() {
      ...
      var table = $('#homeSectionSixDatatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('home_section_six.datatable') }}",
          "columns": [{
                  "data": "id",
                  "defaultContent": ""
              },
          ...
          "columnDefs": [{
                    ...
                    var checked = row.status == 1 ? 'checked' : null;
                      ...
                      <div class="text-center">
                        <label class="switch s-icons s-outline  s-outline-success  mt-3">
                          <input class="section-six-status" type="checkbox"  ` + checked + ` value="` + row.id + `">
              ...
              },
              {
                  ...
                  "render": function(data, type, row, meta) {
                      ...
                      var edit = "{{ route('home_section_six.edit', [':id']) }}";
                      ...
                      return `<div class="text-center">
                            ...
                            <a href="javascript:void(0);" class="section-six-delete" data-toggle="tooltip" data-placement="top" title="Delete" data-id="`+ data + `">
          ...
          $('.section-six-status').change(function () {
            var $this = $(this);
            var id = $this.val();
            ...
            axios
              .post('{{route("home_section_six.status")}}', {
                _token: '{{csrf_token()}}',
                _method: 'patch',
                id: id,
                status: status,
          ...
          $('.section-six-delete').click(function () {
            ...
            swal({
              ...
              if (result.value) {
              axios
                .post('{{route("home_section_six.destroy")}}', {
                  _method: 'delete',
                  _token: '{{csrf_token()}}',
                  deleteId: deleteId,
                })
