                ...
                <ol class="breadcrumb">
                    ...
                    <div style="background: #273443;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Property Management</h5>
                            </div>
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div id="toggleAccordion">
                            <br>
                            <!-- Section Title -->
                            <form action="{{ route('property-management.SectionTitle.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="...">
                                                <section class="mb-0 mt-0">
                                                    <div role="menu" class="collapsed" data-toggle="collapse" data-target="#sectionTitle" aria-expanded="true" aria-controls="sectionTitle"> Section Title <div class="icons"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg></div>
                                                    </div>
                                                </section>
                                            </div>

                                            <div id="sectionTitle" class="collapse" aria-labelledby="..." data-parent="#toggleAccordion">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-5 mt10">
                                                            <label for="">Main Heading <span class="text-danger"> * </span></label>
                                                            <input type="text" name="mainHeading" value="{{ $section_title->heading }}" class="form-control" placeholder="Description..." required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <!-- Section One -->
                            <form action="{{ route('property-management.SectionOne.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="_method" value="put">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-5 mt10">
                                                            ...
                                                            <input type="text" name="mainHeading" value="{{ $section_1->heading }}" class="form-control" placeholder="Description..." required>
                                                        </div>
                                                        <div class="col-md-7 mt10">
                                                            <label for="">Description <span class="text-danger"> * </span></label>
                                                            <textarea name="description" class="form-control" placeholder="Description..." required>{{ $section_1->description }}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <!-- <a href="{{ route('property-management.SectionTwo.create') }}" class="btn btn-dark mb-2 ml-1 mr-4 mt-2"> Add</a> -->
                                </div>
                            </div>
                            ...
                            <!-- Section Three -->
                            <form action="{{ route('property-management.SectionThree.update') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <!-- <input type="hidden" name="_method" value="put"> -->
                                            ...
                                            <div id="sectionTwo" class="collapse" aria-labelledby="..." data-parent="#toggleAccordion">
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-5 mt10">
                                                            <label for="">Main Heading <span class="text-danger"> * </span></label>
                                                            <input type="text" name="mainHeading" value="{{ $section_3->heading }}" class="form-control" placeholder="Description..." required>
...
@include('cms.pages.property_management.section_two.includes.property-management-section-two-js')
