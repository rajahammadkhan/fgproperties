                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-5 mt10">
                                                            ...
                                                            <input type="text" name="mainHeading" value="" class="form-control" placeholder="Description..." required>
                                                        </div>
                                                        <div class="col-md-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10 mt10">
                                                            ...
                                                            <textarea class="form-control-lg" cols="129" rows="20" name="description"> </textarea>
                                                        </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            ...
                                                            <textarea cols="100" rows=" 20"class="" name="description"></textarea>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label>Image <small> ( Dimensions : 611 x 474 ) </small> <span class="text-danger"> * </span> </label>
                                                            ...
                                                            <div class="images">
                                                                <div class="section-three-photo">
                                                                    <img src="{{url('')}}/uploads/" id="section-three-preview" class="img-thumbnail browse-section-three">
                                                                </div>
                                                                @if ($errors->has('bg_image'))
                                                                    <div class="error">{{ $errors->first('bg_image') }}</div>
                                                                @endif
                                                        ...
                                                        <div class="col-md-5 mt10">
                                                            ...
                                                            <input type="text" name="subHeading[]" value="" class="form-control" placeholder="Description..." required>
                                                            @if ($errors->has('Description'))
                                                                <div class="error">{{ $errors->first('Description') }}</div>
                                                            @endif
                                                        </div>
                                                        <div class="col-md-5 mt10">
                                                            ...
                                                            <input type="text" name="subDescription[]" value="" class="form-control" placeholder="Description..." required>
                                                            @if ($errors->has('Description'))
                                                                <div class="error">{{ $errors->first('Description') }}</div>
                                                            @endif
                                                        </div>
                                            ...
                                            <div id="sectionFive" class="collapse" aria-labelledby="..." data-parent="#toggleAccordion">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-5 mt10">
                                                            <label for="">Sub Heading <span class="text-danger"> * </span></label>
                                                            <input type="text" name="subheading" value="" class="form-control" placeholder="Sub Heading..." required>
                                                        </div>
                                                        <div class="col-md-5 mt10">
                                                            <label for="">Main Heading <span class="text-danger"> * </span></label>
                                                            <input type="text" name="mainHeading" value="" class="form-control" placeholder="Description..." required>
...
@include('cms.pages.sell.section_two.includes.sell-section-two-js')
