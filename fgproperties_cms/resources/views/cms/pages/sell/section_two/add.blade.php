            ...
            <div class="row layout-top-spacing" id="cancel-row">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="">Section Four</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{$isEdit ? 'Edit' : 'Add'}}</li>
                    </ol>
                
                        
                    <form action="{{ $isEdit ? route('about-us.SectionFour.update', [$sectionFour->id]) : route('about-us.SectionFour.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if ($isEdit)
                        ...
                        <div class="widget-content widget-content-area">
                            <div class="form-row mb-4">
                                <div class="col-md-5">
                                    <label>Image <small>( Dimension : 1170 x 400 )</small> <span class="text-danger"> *</span> </label>
                                    <input {{!$isEdit ? 'required' : null}} type="file" name="image"  class="file" accept="image/*" >
                                    <div class="images">
                                        <div class="photo">
                                            <img src="{{url('')}}/uploads/{{$sectionFour->image ?? 'placeholder.png'}}" id="preview" class="img-thumbnail browse">
                                        </div>
                                        @if ($errors->has('image'))
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12 mt10">
                                        <label>Heading</label>
                                        <input type="texr" name="mainHeading" class="form-control" value="{{ $sectionFour->main_heading_1 }}">
                                    </div>
                                    <div class="col-md-12 mt10">
                                        <label>Description</label>
                                        <textarea class="form-control" name="description">{{ $sectionFour->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
