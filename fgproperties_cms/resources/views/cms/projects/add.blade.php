    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <form action="{{ $isEdit ? route('project.update', [$projects->id]) : route('project.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div style="background: #294159;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Projects / {{$isEdit ? 'Edit' : 'Add'}}</h5>
                            </div>

                            <div class="col-md-6 text-right">
                                <a href="{{route('projects')}}" class="btn btn-danger"> 
                    ...
                    <div class="form-row mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$projects->featured_image ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <!-- <input type="file" name="agent_img"  
                                    @if($isEdit) value="{{url('')}}/uploads/{{ $projects->agent_image }}"
                                    @else value="{{ url('') }}/uploads/{{ Auth::user()->image }}" @endif 
                                     class="file2" accept="image/*" > -->
                                     <input type="text" name="agent_img"  
                                    @if($isEdit) value="{{ $projects->agent_image ?? old('title') ?? null }}"
                                    @else value="{{ Auth::user()->image }}" @endif 
                                     class="file2" >
                                <div class="images">
                                    <div class="photo">
                                        @if($isEdit)
                                        <img src="{{url('')}}/uploads/{{$projects->agent_image ?? 'placeholder-small.jpg'}}" id="preview2" class="img-thumbnail browse2">
                                        @else
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$projects->bannar_image ?? 'placeholder-small.jpg'}}" id="preview1" class="img-thumbnail browse1">
                                    </div>
                                    @if ($errors->has('bannar_image'))
                                        <div class="error">{{ $errors->first('bannar_image') }}</div>
                                    @endif
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="name" id="name" 
                                            class="form-control" placeholder="Enter Name..." autofocus="true" required value="{{ $projects->title ?? old('title') ?? null }}">
                                        @if ($errors->has('title'))
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="agent_name" id="name" 
                                            class="form-control" placeholder="Enter Name..." autofocus="true" @if($isEdit) value="{{ $projects->agent_name ?? old('agent_name') ?? Auth::user()->name }}"@else value="{{ Auth::user()->name}}" @endif readonly="">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="phone" name="phone" 
                                            class="form-control" placeholder="Phone"  @if($isEdit) value="{{ $projects->phone ?? old('phone') ?? Auth::user()->phone }}"@else value="{{ Auth::user()->phone}}" @endif readonly="">
                                        @if ($errors->has('phone'))
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="email" name="email" 
                                            class="form-control" placeholder="Email" @if($isEdit) value="{{ $projects->email ?? old('email') ?? Auth::user()->email }}"@else value="{{ Auth::user()->email}}" @endif readonly="">
                                        @if ($errors->has('email'))
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="price" value="{{ $projects->price ?? old('price') ?? null }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="url" value="{{ $projects->url ?? old('url') ?? null }}"
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" name="ext_ref_num" value="{{ $projects->ext_ref_num ?? old('ext_ref_num') ?? null }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="permit_no" value="{{ $projects->permit_no ?? old('permit_no') ?? null }}"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="custom-select" id="inputGroupSelect01" name="network_id" {{!$isEdit ? 'required' : null}}>
                                            ...
                                            @foreach($developers as $developer)
                                                <option @if($isEdit){{ $projects->developer_id == $developer->id ? 'selected' : null }}@endif value="{{ $developer->id }}" class="dropdown-item" >{{ $developer->developer_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="bedrooms" 
                                            class="form-control" placeholder="No of Bedrooms" value="{{ $projects->bedrooms ?? old('bedrooms') ?? null }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="bathrooms" 
                                            class="form-control" placeholder="No of bathrooms" value="{{ $projects->bathrooms ?? old('bathrooms') ?? null }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select class="custom-select property-type" name="type" required> 
                                            ...
                                            <option @if($isEdit){{ $projects->type == $type->type ? 'selected' : null }}@endif value="{{ $type->type }}">{{$type->type}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-6 areasqft">
                                        ...
                                        <input type="text" name="area" 
                                            class="form-control" placeholder="Area" value="{{ $projects->area ?? old('area') ?? null }}" >
                                        @if ($errors->has('area'))
                                    ...
                                    <div class="form-group col-6 bultsqft" style="display: none">
                                        ...
                                        <input type="text" name="builtArea" 
                                            class="form-control" placeholder="Area" value="{{ $projects->built_area ?? old('built_area') ?? null }}" >
                                        @if ($errors->has('area'))
                                            <div class="error">{{ $errors->first('area') }}</div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-group col-6 plotsqft" style="display: none">
                                        ...
                                        <input type="text" name="plotArea" 
                                            class="form-control" placeholder="Area" value="{{ $projects->plot_area ?? old('plot_area') ?? null }}" >
                                        @if ($errors->has('area'))
                                            <div class="error">{{ $errors->first('area') }}</div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="guests" 
                                            class="form-control" placeholder="Guestrooms" value="{{ $projects->guests ?? old('guests') ?? null }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="seo_title" 
                                            class="form-control" placeholder="Seo Title" required value="{{ $projects->seo_title ?? old('seo_title') ?? null }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="meta_description" 
                                            class="form-control" placeholder="Meta Description" required value="{{ $projects->meta_description ?? old('meta_description') ?? null }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="meta_keywords" 
                                            class="form-control" placeholder="Meta Keywords" required value="{{ $projects->meta_keywords ?? old('meta_keywords') ?? null }}">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea cols="200" class="form-control" name="amenities" {{!$isEdit ? 'required' : null}}>{!! $projects->amenities ?? null !!}</textarea>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea cols="200" class="summernote" name="description" {{!$isEdit ? 'required' : null}}>{!! $projects->description ?? null !!}</textarea>
                            </div>

                             <div class="col-md-12">
                                <label>Nearby Hospitals <small>( Separate by a coma ',' )</small></label>
                                <textarea cols="200" class="form-control" name="nearby_hospitals" {{!$isEdit ? 'required' : null}}>{{ $projects->nearest_hospitals ?? null }}</textarea>
                            </div>

                            <div class="col-md-12">
                                <label>Nearby Schools <small>( Separate by a coma ',' )</small></label>
                                <textarea cols="200" class="form-control" name="nearby_schools" {{!$isEdit ? 'required' : null}}>{!! $projects->nearest_schools ?? null !!}</textarea>
                            </div>

                            <div class="col-md-12">
                                <label>Nearby Shopping Malls <small>( Separate by a coma ',' )</small></label>
                                <textarea cols="200" class="form-control" name="nearby_shopping_malls" {{!$isEdit ? 'required' : null}}>{!! $projects->nearest_shopping_malls ?? null !!}</textarea>
                            </div>

                            <div class="col-md-12">
                                <label>Nearby Gyms <small>( Separate by a coma ',' )</small></label>
                                <textarea cols="200" class="form-control" name="nearby_gyms" {{!$isEdit ? 'required' : null}}>{!! $projects->nearest_gyms ?? null !!}</textarea>
                            </div>
...
@include('cms.projects.includes.amenities-js')
