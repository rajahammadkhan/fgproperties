                            ...
                            <div class="row">
                                <div class="col-md-6 mt15 pl30">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('blog.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add</a>
                                    </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <table id="datatable" class="table table-bordered table-hover table-condensed mb-4" width="100%" cellspacing="0"
                            ...
                            <thead class="datatable">
                                <tr>
                                    ...
                                    <th>Name</th>
            @if(auth()->user()->can('blogs-edit') || auth()->user()->can('blogs-delete'))
...
@include('cms.blogs.includes.blogs-js')
@endsection
