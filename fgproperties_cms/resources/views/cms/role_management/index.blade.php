                        ...
                        <div class="row">
                            ...
                            @can('roles-add')
                                <div class="col-md-6 text-right">
                                    <a href="{{ route('role.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add Role</a>
                                </div>
                            @endcan
                        </div>
                    </div>
                        <br>
                        <table id="datatable" class="table table-bordered table-striped mt-5" width="100%" cellspacing="0"
                            cellpadding="0">
...
@section('bottom-mid-scripts')
    ...
    <script src="http://cms.yourstitchart.com/js/sweetalert2.min.js"></script>
@endsection
@section('bottom-bot-scripts')
@include('cms.role_management.includes.roles-js')
@endsection
