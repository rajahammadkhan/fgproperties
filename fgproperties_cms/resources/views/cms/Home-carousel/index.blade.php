                        ...
                        <div style="background-color: #294159;">
                            <div class="row">
                                <div class="col-md-6 mt15 pl30">
                                    <h5 class="text-white">Home Carousel</h5>
                                </div>
                                <div class="col-md-6 text-right">
                                    <a href="{{ route('HomeCarousel.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add Carousel Image</a>
                                </div>
                            </div>
                        </div>
                        <br>
...
@include('cms.Home-carousel.includes.Home-Carousel-js')
@endsection
