                        ...
                        <div style="background-color: #294159;">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <a href="{{ route('developer.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add Developer</a>
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <table id="datatable" class="table table-bordered table-hover table-condensed mb-4" width="100%" cellspacing="0"
                            ...
                            <thead class="datatable">
                                <tr>
                                   ...
                                   <!-- <th class="no-sort text-center" width="5%">Logo</th> -->
                                   <!-- <th class="no-sort text-center" width="5%">Featured</th> -->
...
@include('cms.developers.includes.developers-js')
@endsection
