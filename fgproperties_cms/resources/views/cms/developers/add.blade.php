        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('developers')}}">Developers</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{$isEdit ? 'Edit' : 'Add'}}</li>
                </ol>
                
                        
                <form action="{{ $isEdit ? route('developer.update', [$developer->id]) : route('developer.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div style="background: #294159;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Developers / {{$isEdit ? 'Edit' : 'Add'}}</h5>
                            </div>

                            <div class="col-md-6 text-right">
                                <a href="{{route('developers')}}" class="btn btn-danger"> 
                    ...
                    <div class="form-row mb-4">
                            ...
                            <div class="col-md-3">
                                <label>Logo <small>( Dimension : 1920 x 874 )</small> <span class="text-danger"> *</span> </label>
                                <input  type="file" name="logo"  class="file" accept="image/*" >
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$developer->logo ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                    @if ($errors->has('image'))
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="name"  id="name" value="{{ $developer->network_name ?? old('name') ?? null }}"
                                            class="form-control" placeholder="Enter Name..." autofocus="true" required>
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="meta_title" id="meta_title" value="{{ $developer->meta_title ?? old('meta_title') ?? null }}"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="keywords" id="keywords" value="{{ $developer->keywords ?? old('keywords') ?? null }}"
                                    ...
                                    <!-- <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="website" value="{{ $developer->website ?? old('website') ?? null }}"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="address" value="{{ $developer->address ?? old('address') ?? null }}"
                            ...
                            <!-- <div class="col-12">
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="email" value="{{ $developer->email ?? old('email') ?? null }}"
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="phone" value="{{ $developer->phone ?? old('phone') ?? null }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" name="meta_description" id="meta_description" value="{{ $developer->meta_description ?? old('meta_description') ?? null }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea cols="200" class="summernote" name="description">{!! $developer->description ?? null !!}</textarea>
                            </div>
