            ...
            <div class="row layout-top-spacing" id="cancel-row">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Properties For Sell</li>
                    </ol>
                    <div class="widget-content widget-content-area br-6">
                        <div style="background-color: #294159;">
                            <div class="row">
                                <div class="col-md-6 mt15 pl30">
                                    <h5 class="text-white">Properties For Sell</h5>
                                </div>
                                @can('Listings-add')
                                <div class="col-md-6 text-right">
                                    <a href="{{ route('sell.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add Property</a>
                                </div>
                                @endcan
                            </div>
                        </div>
                        ...
                        <table id="datatable" class="table table-bordered table-hover table-condensed mb-4" width="100%" cellspacing="0"
                            ...
                            <thead class="datatable">
                                <tr>
                                    ...
                                    <th class="no-sort text-center" width="8%">Published</th>
                                    @endif
                                </tr>
                            </thead>
                        </table>
...
@include('cms.sell.includes.properties-js')
@endsection
