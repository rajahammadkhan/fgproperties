            ...
            <div class="row layout-top-spacing" id="cancel-row">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Properties For Rent</li>
                    </ol>
                    <div class="widget-content widget-content-area br-6">
                        <div style="background-color: #294159;">
                            <div class="row">
                                <div class="col-md-6 mt15 pl30">
                                    <h5 class="text-white">Properties For Rent</h5>
                                </div>
                                @can('Listings-add')

                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('rent.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add Project</a>
                                    </div>
                                @endcan
                            </div>
                        </div>
...
@include('cms.rent.includes.properties-js')
@endsection
