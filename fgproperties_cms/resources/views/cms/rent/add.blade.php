            ...
            <div class="row layout-top-spacing" id="cancel-row">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('rent')}}">Rent</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{$isEdit ? 'Edit' : 'Add'}}</li>
                    </ol>
                    
                            
                    <form action="{{ $isEdit ? route('rent.update', [$project->id]) : route('rent.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if ($isEdit)
                        ...
                        <div style="background: #294159;">
                            <div class="row">
                                <div class="col-md-6 mt15 pl30">
                                    <h5 class="text-white">Rent / {{$isEdit ? 'Edit' : 'Add'}}</h5>
                                </div>

                                <div class="col-md-6 text-right">
                                    <a href="{{route('rent')}}" class="btn btn-danger"> 
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea cols="50" class="summernote" name="description" {{!$isEdit ? 'required' : null}}>{!! $project->description ?? null !!}</textarea>
                                </div>
                                <div class="col-md-12">
...
@include('cms.rent.includes.amenities-js')
