                        ...
                        <div style="background-color: #294159;">
                            <div class="row">
                                <div class="col-md-6 mt15 pl30">
                                    <h5 class="text-white">Amenities</h5>
                                </div>
                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('amenities.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add Amenity</a>
                                    </div>
                            </div>
                        </div>
                        <br>
...
@include('cms.amenities.includes.amenities-js')
