        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('developers')}}">Amenities</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{$isEdit ? 'Edit' : 'Add'}}</li>
                </ol>
                
                        
                <form action="{{ $isEdit ? route('amenities.update', [$amenity->id]) : route('amenities.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                    ...
                    <div style="background: #294159;">
                        <div class="row">
                            <div class="col-md-6 mt15 pl30">
                                <h5 class="text-white">Amenities / {{$isEdit ? 'Edit' : 'Add'}}</h5>
                            </div>
                    ...
                    <div class="form-row mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="images">
                                    <div class="photo">
                                        <img src="{{url('')}}/uploads/{{$amenity->logo ?? 'placeholder-small.jpg'}}" id="preview" class="img-thumbnail browse">
                                    </div>
                                    @if ($errors->has('image'))
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="">Amenity Name <span class="text-danger"> * </span></label>
                                        <input type="text" name="name" value="{{ $amenity->network_name ?? old('name') ?? null }}"
                                            class="form-control" placeholder="Amenity Name " required>
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="">Sort Order <span class="text-danger"> * </span></label>
                                        <input type="text" name="sort_order" value="{{ $amenity->phone ?? old('phone') ?? null }}"
                                            class="form-control" placeholder="Sort Order " required>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea cols="200" class="summernote" name="description">{!! $amenity->meta_description ?? null !!}</textarea>
                            </div>
