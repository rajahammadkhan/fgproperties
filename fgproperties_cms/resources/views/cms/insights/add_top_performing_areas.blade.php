    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <form action="{{ $isEdit ? route('insight.update_top_performing_areas', [$topPerformingAreas->id]) : route('insight.store_top_performing_areas') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="year"  id="name" value="{{ $topPerformingAreas->area_name ?? old('area_name') ?? null }}"
                                            class="form-control" placeholder="Enter Area Name..." autofocus="true">
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="meta_title">Rank <span class="text-danger">*</span></label>
                                        <input type="text" name="january" id="meta_title" value="{{ $topPerformingAreas->rank ?? old('rank') ?? null }}"
                                            class="form-control" placeholder="Enter Popularity..." readonly >
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="meta_title">Popularity <span class="text-danger">*</span></label>
                                        <input type="text" name="january" id="meta_title" value="{{ $topPerformingAreas->popularity ?? old('popularity') ?? null }}"
                                            class="form-control" placeholder="Enter Popularity..." >
                                        @if ($errors->has('meta_title'))
                                            <div class="error">{{ $errors->first('meta_title') }}</div>
                                        @endif
                                    </div>
