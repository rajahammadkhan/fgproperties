    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <form action="{{ $isEdit ? route('insight.update_property_sales_value', [$propertySalesValue->id]) : route('insight.store_property_sales_value') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($isEdit)
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="year"  id="name" value="{{ $propertySalesValue->year ?? old('year') ?? null }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="january" id="meta_title" value="{{ $propertySalesValue->january ?? old('january') ?? null }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="february" id="keywords" value="{{ $propertySalesValue->february ?? old('february') ?? null }}"
                                        ...
                                        <input type="text" name="march" id="meta_title" value="{{ $propertySalesValue->march ?? old('march') ?? null }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="april" id="keywords" value="{{ $propertySalesValue->april ?? old('april') ?? null }}"
                                        ...
                                        <input type="text" name="may" id="meta_title" value="{{ $propertySalesValue->may ?? old('may') ?? null }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="june" id="keywords" value="{{ $propertySalesValue->june ?? old('june') ?? null }}"
                                        ...
                                        <input type="text" name="july" id="meta_title" value="{{ $propertySalesValue->july ?? old('july') ?? null }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="august" id="keywords" value="{{ $propertySalesValue->august ?? old('august') ?? null }}"
                                        ...
                                        <input type="text" name="september" id="meta_title" value="{{ $propertySalesValue->september ?? old('september') ?? null }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="october" id="keywords" value="{{ $propertySalesValue->october ?? old('october') ?? null }}"
                                        ...
                                        <input type="text" name="november" id="meta_title" value="{{ $propertySalesValue->november ?? old('november') ?? null }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="december" id="keywords" value="{{ $propertySalesValue->december ?? old('december') ?? null }}"
