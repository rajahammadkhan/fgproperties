                        ...
                        <div class="grid grid-cols-12">
                            <div class="col-span-12">
                                <div class="relative selectricc-border-none">
                                    ...
                                    <div id="buy" class="active tab-content bg-[rgb(237,252,250,0.9)] border border-solid border-[#016450] rounded-bl-[15px] rounded-br-[15px] rounded-tr-[15px] px-[15px] sm:px-[30px] py-[28px] lg:max-h-56 overflow-visible">
                        ...
                        <div class="relative">
                            ...
                            <span class="absolute bottom-5 right-5 bg-[#FFFDFC] p-[5px] rounded-[2px] text-primary leading-none text-[14px] font-normal capitalize"> 
                                @foreach($developers as $developer)
                                    @if($developer->id == $property->developer_id)
