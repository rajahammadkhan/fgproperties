                    ...
                    <div class="col-span">
                        <div class="flex flex-wrap items-center justify-between py-[30px] xl:py-[40px] px-[30px] xl:px-[55px] shadow-[0px_10px_20px_rgba(196,196,196,0.5)] rounded-[15px] border border-[rgba(1,100,80,0.25)] bg-white mb-[80px] lg:mb-[-75px]">
                            <div class="w-full lg:w-auto">
                                <h3 class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-[36px] leading-[1.277] mb-[10px]">Are you a Home Owner?</h3>
                            ...
                            <div class="w-full lg:w-auto mt-5 lg:mt-0">
                                <form id="mc-form" action="#" class="relative w-full">
                                    ...
                                    <button id="mc-submit" type="submit" class="text-white font-medium text-[16px] leading-none tracking-[0.02em] bg-secondary py-[15px] px-[20px] mt-5 sm:mt-0 rounded-[10px] bg-[#D2AC47] hover:bg-primary transition-all sm:absolute sm:right-[5px] sm:top-1/2 sm:-translate-y-1/2" style="">Get Listed</button>
                                </form>
...
<!-- Footer Start -->
        <footer class="footer bg-[#ECFAF7] pt-[80px] lg:pt-[200px] pb-30 md:pb-[80px] lg:pb-[110px] font-normal bg-no-repeat" style="background-image: url('assets/images/footer/pattern.png');">
            <div class="container">
                <div class="grid grid-cols-12 gap-x-[60px] mb-[-70px]">
                    <div class="col-span-12 sm:col-span-3 lg:col-span-3 mb-[30px]">
                        ...
                        <p class="mb-[5px] xl:mb-[40px] max-w-[270px]">{{ getSettings('footer_about') }} </p>
                    ...
                    <div class="col-span-12 sm:col-span-3 lg:col-span-2 mb-[30px]">
                        ...
                        <ul class="text-[16px] leading-none mb-[-20px]">
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="{{ route('buy') }}">Buy</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="{{ route('rent') }}">Rent</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="{{ route('sell') }}">Sell</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="{{ route('project') }}">Projects</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="{{ route('blog') }}">Blog</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="{{ route('contactus') }}">Contact Us</a></li>
                        </ul>
                    </div>
                    <div class="col-span-12 sm:col-span-3 lg:col-span-2 mb-[30px]">
                        <h3 class="font-lora font-normal text-[22px] leading-[1.222] text-primary mb-[20px] lg:mb-[30px]">
                        ...
                        <ul class="text-[16px] leading-none mb-[-20px]">
                            ...
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="{{ route('projects.developer',$dev->slug ) }}">{{$dev->developer_name}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="col-span-12 sm:col-span-3 lg:col-span-2 mb-[30px]">
                        ...
                        <ul class="text-[16px] leading-none mb-[-20px]">
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="#">Add Property</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="#">Our Agents</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="#">Terms & Conditions</a>
                            </li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="#">Privacy Policy</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="{{ route('about.us') }}">About Us</a></li>
                    ...
                    <div class="col-span-12 sm:col-span-3 lg:col-span-3 mb-[30px]">
                        ...
                        <p class="max-w-[270px]">{{ getSettings('address') }}</p>
                        <p class="mt-[10px]">{{ getSettings('contact_no_1') }} </p>
                        <p  class="mt-[10px] mb-[3rem]">{{ getSettings('website_email_1') }}</p>
