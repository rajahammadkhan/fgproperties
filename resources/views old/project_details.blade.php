                    ...
                    <div class="col-span-12 md:col-span-6 lg:col-span-8 mb-[30px]">
                        ...
                        <div class="mt-[45px] mb-[35px]">
                            ...
                            <h4 class="font-lora leading-tight text-[16px] md:text-[20px] lg:text-[20px] text-primary mb-[1rem] mt-[1rem] font-medium">
                                   ...
                                   Starting Price: <span class="font-lora leading-tight text-[18px] md:text-[24px] lg:text-[24px] text-primary mb-[5px] font-medium"><b>AED {{ number_format($projects->price) }}</b></span>
                                @else
                ...
                <div class="grid grid-cols-12">
                    <div class="col-span-12">
                        <div class="mb-[30px] lg:mb-[20px] text-center">
                            <h2 class="font-lora text-primary text-[24px] sm:text-[40px] capitalize font-medium"><b>Similar Projects</b></h2>
                        </div>
                    ...
                    @foreach($similar_proj as $sim_proj)
                        <div class="swiper-slide text-center">
                            ...
                            <div class="py-[20px] px-[20px]">
                                ...
                                <h4><a href="{{ route('project_details',$sim_proj->id) }}" class="font-light text-tiny underline">
                                    @if($sim_proj->url != "")
                                        {{$sim_proj->url}}
                                    @else
                                        UAE
                                ...
                                <!-- <p class="font-light">{{$sim_proj->area}} Sq.fit - {{$sim_proj->bedrooms}} Bed - {{$sim_proj->bathrooms}} Bath</p> -->
                                <p class="font-light">
                                    @if($sim_proj->area != "")
