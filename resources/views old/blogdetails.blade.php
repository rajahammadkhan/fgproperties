                ...
                <div class="grid grid-cols-1 ">
                    <div class="col-span-12 ">
                        <div class="max-w-[700px]  mx-auto text-center text-white relative z-[1]">
                            ...
                            <h1 class="font-lora text-[1.8rem] sm:text-[40px] md:text-[68px] lg:text-[50px] leading-tight font-medium md:mt-[-0rem]">
                                {{$blog->name}}  
                            </h1>
                ...
                <div class="grid grid-cols-12 mb-[-30px] gap-[30px] xl:gap-[50px]">
                    <div class="col-span-12 md:col-span-66 lg:col-span-66 mb-[30px]">
                        <div class="mt-[55px] mb-[35px]">
                            <span class="block leading-none font-normal text-[18px] text-secondary mb-[5px] relative before:absolute before:left-0 before:top-1/2 -translate-y-1/2 before:bg-secondary before:content-[''] before:w-[3px] before:h-[3px] before:rounded-full before:block pl-[10px] lg:text-[20px]">{{ Carbon\Carbon::parse($blog->date)->format('d-M-Y') }}</span>
                            <h2 class="font-lora leading-tight text-[22px] md:text-[28px] lg:text-[36px] text-primary mb-[10px] font-medium">
                                {{ $blog->name }}</h2>
                        </div>

                        <img src="{{config('fgproperties.file_path').$blog->image}}" class="w-auto h-auto mt-[10px]" loading="lazy" alt="Elite Garden Resedence." style="width:100%; height: 505px;">
