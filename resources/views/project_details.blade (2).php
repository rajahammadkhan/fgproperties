...
<!-- Popular Properties start -->
        <section class="popular-properties py-[80px] lg:py-[120px] md:mb-[-10rem] mt-[-6rem]">
            <div class="container">
                ...
                <div class="grid grid-cols-12 mb-[-30px] gap-[30px] xl:gap-[50px]">
                    <div class="col-span-12 md:col-span-6 lg:col-span-8 mb-[30px]">
                        <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2">
                          <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide md:h-[30rem]">
                              <img src="{{config('fgproperties.file_path').$images}}" class="h-[25rem]" style="width:100%;" />
                            </div>
                          @php 
                          }
                                }
                        ...
                        <div thumbsSlider="" class="swiper mySwiper mt-[0.5rem] lg:mt-[-2rem]">
                          <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide mt-[0.5rem] lg:mt-[-2rem]">
                              <img src="{{config('fgproperties.file_path').$images}}" class="h-[4rem] md:h-[6rem]" style="width:100%;" />
                            </div>
                          @php }
                                }
                            } 
                        ...
                        <div class="mt-[45px] mb-[35px]">
                                <div class="grid md:grid-cols-2 grid-cols-1">
                                    <h2 class="font-lora leading-tight text-[26px] md:text-[26px] lg:text-[26px] text-primary mb-[5px] font-medium"><b>{!! $projects->title !!}</b></h2>
                            ...
                            @if($projects->price != "")
                            <hr>
                            <h4 class="font-lora leading-tight text-[14px] md:text-[20px] lg:text-[20px] text-primary mb-[1rem] mt-[1rem] font-medium">
                                   Starting Price: <span class="font-lora leading-tight text-[22px] md:text-[22px] lg:text-[22px] text-primary mb-[5px] font-medium"><b>AED {{ number_format($projects->price) }}</b></span> 
                            </h4>
                            @endif
                            <hr>

                            
                            <h4 class="font-lora leading-tight text-[22px] md:text-[22px] lg:text-[22px] text-primary mb-[5px] mt-[1rem] font-medium">About This Listing</h4>
                            <p class="mt-[1rem]">
                        ...
                        <h4 class="font-lora text-primary text-[20px] leading-[1.277] sm:text-[20px] capitalize mt-[50px] mb-[40px] font-medium">
                    ...
                    <div class="rounded-[20px] bg-[#F5F9F8] border-solid border-[1px] pt-[1rem] pb-[1rem] pl-[1rem] pr-[1rem]">
                        <div class="grid grid-cols-12 ">
                            <div class="col-span-12 flex flex-wrap flex-col md:flex-row md:items-center justify-between ">
                                <div class="mb-0 xl:mb-0">
                                    <h2 class="font-lora text-primary text-[24px] sm:text-[28px] capitalize font-medium">
                                        <b>Mortgage Calculator</b><span class="text-secondary">.</span></h2>
                                </div>
                            </div>
                        </div>

                            
                            <div class="flex flex-wrap transition-all pt-[20px] pl-[1rem] pr-[1rem] rounded-[8px]  min-w-full mt-[-1rem]">
                                <div class="flex-1 grid grid-cols-4 content-evenly">
                            ...
                            <div class="grid grid-cols-2 grid-rows-8 gap-x-3 ">
                                
                                    <div class="flex flex-wrap  bg-[#F5F9F8] transition-all pt-[2rem] pl-[1rem] pr-[1rem] rounded-[8px]  row-start-1 row-end-5 min-w-[200px]">
                                        <div class="flex-1">
                                            <h4 class="font-lora leading-none text-[20px] sm:text-[20px] text-primary mb-[10px] ">No of Payments 
                                                <span class="text-secondary ml-5 "><b class="no-of-payment">192</b></span>
                                            </h4>
                                            <hr>

                                            <h4 class="font-lora leading-none text-[20px] sm:text-[20px] text-primary mb-[10px] mt-8">Monthly Installments 
                                                <span class="text-secondary ml-5 "><b class="monthly-installment">AED 40,766</b></span>
                                            </h4>
                                            <hr>

                                            <h4 class="font-lora leading-none text-[20px] sm:text-[20px] text-primary mb-[10px] mt-8">Property Price 
                                                <span class="text-secondary ml-5"><b>AED {{ number_format($projects->price) }}</b></span>
                                            </h4>
                                            <hr>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-wrap bg-[#F5F9F8] transition-all pt-[1rem] pl-[4rem] pr-[4rem] rounded-full  max-w-[20rem] text-center ml-10 ">
                                        <div class="flex-1 align-middle border-[1px] border-black rounded-full bg-[white]">
                                            <h4 class="font-lora leading-none text-[15px] sm:text-[15px] text-primary mb-[10px] mt-[3.5rem] font-semibold">Estimated Mo. Payment 
                                                <p class="text-secondary mt-2 text-[25px] sm:text-[25px] monthly-installment"><b>AED 40,766</b></p>
                                                <p class="font-lora text-primary text-[15px] mt-2 mb-[3.5rem] font-semibold">Based on <b class="loan-period">16</b> Year Fixed</p>
                                            </h4>
                            ...
                            <div class="bg-[#F5F9F8] px-[20px] lg:px-[15px] xl:px-[35px] py-[50px] rounded-[8px] mb-[40px]" >
                                <div class="cities-slider" id="cities-slider">
                                    <div class="swiper -mx-[10px] -my-[30px] px-[10px] py-[30px] " id="swiper">
                                        ...
                                        <h3 class="text-primary leading-none text-[22px] font-lora mb-[30px] font-medium"><b>Book Your Viewing</b></h3>
                                            ...
                                            <div class="swiper-slide text-center ">
                                                <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]" >
                                                    ...
                                                    <div class="py-[20px] px-[15px]">
                                                        <h4><a href="#" class="font-light text-tiny ">
                                                             {{$date->format('F')}}
                                                        </a></h4>
                                                        <h3><a href="#" class="font-lora leading-tight text-[20px] xl:text-[22px] text-primary font-medium">{{$date->format('d')}}</a></h3>
                                                        <h4><a href="#" class="font-light text-tiny ">
                                                            {{$date->format('l ')}}
                                                        </a></h4>
                ...
                <div class="grid grid-cols-12">
                    <div class="col-span-12">
                        <div class="mb-[30px] lg:mb-[20px] text-center">
                            <h2 class="font-lora text-primary text-[25px] sm:text-[25px] capitalize font-medium"><b>Similar Projects</b></h2>
                        </div>
                        ...
                        <div class="swiper-slide text-center">
                            <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px] w-[100%] min-h-[30rem]">
                                ...
                                <div class="py-[20px] px-[20px] text-left">
                                    <h3><a href="{{ route('project_details',$sim_proj->id) }}" class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary font-medium"> {{$sim_proj->title}}</a></h3>
...
$('.loan-period-input').on('input', function() {
   ...
   let x = y * 12;
    $('.no-of-payment').html(x);
    $('.loan-period').html($('.loan-period-input').val());
    ...
    $('.monthly-installment').html('AED '+monthlyInstallment.toLocaleString('en-US'));
});
