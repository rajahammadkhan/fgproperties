                ...
                <div class="">
                    <div class="">
                        <div class="mb-[60px] text-center">
                            <h2 class="font-lora text-primary text-[30px] sm:text-[30px] capitalize font-medium">
                                <b>How it Works?</b><span class="text-secondary">.</span></h2>
                        </div>
                    </div>
                    <div class="">
                        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-x-[30px] mt-[-30px]">                            
                            <div class="mb-[30px]" style="background:rgb(237,252,250,0.9); padding: 20px; border-radius: 10px">
                                <div >
                                    <img src="{{url('')}}/assets/images/icon/home_visit.png" style="width: 80px;">
                                    <hr>
                                    <h3><a class="font-lora text-[22px] xl:text-[22px] leading-[1.285] text-primary block mb-[10px] hover:text-secondary transition-all font-medium" style="cursor: default;">1. Home Visit</a></h3>
                                    <p class="font-light text-[#494949] text-[15px] leading-[1.75]">Book your free home visit and we will take care of the photos and floor plans.You will also receive a free valuation guide</p>
                                </div>
                            </div>
                            
                            <div class="mb-[30px]" style="background:rgb(237,252,250,0.9); padding: 20px; border-radius: 10px">
                                <div >
                                    <img src="{{url('')}}/assets/images/icon/marketing.png" style="width: 80px;">
                                    <hr>
                                    <h3><a class="font-lora text-[22px] xl:text-[22px] leading-[1.285] text-primary block mb-[10px] hover:text-secondary transition-all font-medium" style="cursor: default;">2. Marketing</a></h3>
                                    <p class="font-light text-[#494949] text-[15px] leading-[1.75]">We will publish your property on the major property sites in Dubai to drum up interest in your home in order to get maximum visibilty</p>
                                </div>
                            </div>

                            <div class="mb-[30px]" style="background:rgb(237,252,250,0.9); padding: 20px; border-radius: 10px">
                                <div >
                                    <img src="{{url('')}}/assets/images/icon/viewing.png" style="width: 80px;">
                                    <hr>
                                    <h3><a class="font-lora text-[22px] xl:text-[22px] leading-[1.285] text-primary block mb-[10px] hover:text-secondary transition-all font-medium" style="cursor: default;">3. Viewing</a></h3>
                                    <p class="font-light text-[#494949] text-[15px] leading-[1.75]">24/7 access to your Home Companion app where you can arrange viewings and receive offers</p>
                                </div>
                            </div>

                            <div class="mb-[30px]" style="background:rgb(237,252,250,0.9); padding: 20px; border-radius: 10px">
                                <div >
                                    <img src="{{url('')}}/assets/images/icon/sell.png" style="width: 80px;">
                                    <hr>
                                    <h3><a class="font-lora text-[22px] xl:text-[22px] leading-[1.285] text-primary block mb-[10px] hover:text-secondary transition-all font-medium" style="cursor: default;">4. Sell</a></h3>
                                    <p class="font-light text-[#494949] text-[15px] leading-[1.75]">Your personal Support Manager will guide you through the completion date (and with less grey hairs!)</p>
                                </div>
                            </div>                           
                        </div>
                    </div>
            ...
            <div class="container py-[50px] lg:py-[90px] mb-[-100px]">
                    ...
                    <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px] items-end">
                        <div class="col-span-12 lg:col-span-12 mb-[30px]">
                            <div>
                                <h2 class="font-lora text-primary text-[18px] sm:text-[22px] leading-[1.277] capitalize mb-[10px] font-medium">
                            ...
                            <div class="grid grid-cols-12 gap-x-[20px] gap-y-[30px]">
                                ...
                                <div class="col-span-12 md:col-span-6 left-1">
                                    <h2 class="font-lora text-primary text-[18px] sm:text-[22px] leading-[1.277] capitalize mb-[10px] font-medium">
                                        Upload Title Deeds <span style="font-size: 17px; color:gray;">(Optional)</span>

                                    </h2>
                                    <div x-data="showImage()" class="flex items-center ">
                                        <div class="bg-white rounded-[15px] shadow-xl md:w-9/12 lg:w-1/2 relative ">
                                        <!-- <div class="bg-white rounded-lg shadow-xl md:w-9/12 lg:w-1/2 relative left-[1.25rem]"> -->
                                            <div class="m-4 ">
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    <h2 class="font-lora text-primary text-[18px] sm:text-[22px] leading-[1.277] capitalize mb-[10px] font-medium">
                                        Upload Passport <span style="font-size: 17px; color:gray;">(Optional)</span>

                                    </h2>
                                    <div x-data="showImage1()" class="flex items-center ">
                                        <div class="bg-white rounded-[15px] shadow-xl md:w-9/12 lg:w-1/2">
                                            <div class="m-4">
                                                <label class="inline-block mb-2 text-black">Upload
                                                    Image (jpg,png)</label>
                                                <div class="flex items-center justify-center w-full">
                                ...
                                <div class="col-span-12 md:col-span-12">
                                    <h2 class="font-lora text-primary text-[18px] sm:text-[22px] leading-[1.277] capitalize mb-[10px] font-medium">
                                        Upload Images <span style="font-size: 17px; color:gray;">(Optional)</span>

                                    </h2>
                                    <div class="">
                                      <main class="container px-[0px]">
                                        <!-- file upload modal -->
                                        <article aria-label="File Upload Modal" class="relative h-full flex flex-col bg-white shadow-xl rounded-[15px]" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);" ondragleave="dragLeaveHandler(event);" ondragenter="dragEnterHandler(event);">
                                          <!-- overlay -->
                                          <div id="overlay" class="w-full h-full absolute top-0 left-0 pointer-events-none z-50 flex flex-col items-center justify-center rounded-md">
                                            
                                            <p class="text-lg text-blue-700" style="opacity: 0;">Drop files to upload</p>
                                          </div>
