                ...
                <div class="grid grid-cols-12 mb-[-30px] gap-[30px] xl:gap-[50px]">
                    <div class="col-span-12 md:col-span-6 lg:col-span-8 mb-[30px]">
                        ...
                        <div class="grid grid-cols-1 py-[0px]">
                            <div class="h-[305px] min-w-full  rounded-[20px] overflow-hidden xl:ml-[40px] my-[0px]" style="margin-left:0px ;">

                                @if($projects->url != "")
                                   <iframe class="w-full h-full" src="https://www.google.com/maps?q= {!! $projects->url !!}* &output=embed" style="border:0;"  loading="lazy"></iframe>
                                @else
                                   <iframe class="w-full h-full" src="https://www.google.com/maps?q= Uae* &output=embed" style="border:0;"  loading="lazy"></iframe>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="rounded-[20px] bg-[#F5F9F8] border-solid border-[1px] pt-[1rem] pb-[1rem] pl-[1rem] pr-[1rem] mt-4">
                        ...
                        <br>
                            ...
                            <div class="flex flex-wrap grid grid-cols-2 transition-all pt-[20px] pl-[1rem] pr-[1rem] rounded-[8px]  min-w-full mt-[-1rem]" id="mort">
                    ...
                    @endif
                    <x-monthly-Property-Price-Per-Sqft/>
                    ...
                    <div class="col-span-12 md:col-span-6 lg:col-span-4 mb-[30px]">
                        <aside class="mb-[-40px] asidebar" >
                            ...
                            <div class="bg-[#F5F9F8] px-[20px] lg:px-[15px] xl:px-[35px] py-[50px] rounded-[8px] mb-[40px]" >
                                ...
                                <a href="https://wa.me/{{$projects->phone}}" target="_blank "class="mt-5">
    ...
    <div class="application-modal fixed w-4/2 h-100 inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster" style="background: rgba(0,0,0,.7); display: none !important;">
        <div class="border shadow-lg modal-container bg-white w-4/2 mx-auto rounded-lg shadow-lg z-50 overflow-y-auto">
            <div class="modal-content py-4 text-left px-6">
                ...
                <hr>
                <div class="grid grid-cols-2 gap-x-10" id="mort" >
                    <div class="grid grid-cols-1 lg:border-r md:border-r pl-4 pr-[3rem]">
                        <div class="inline-grid grid-cols-2 w-full border-b">    
                    ...
                    <div class="grid grid-cols-1">
                        <form method="post"  action="{{ route('mortgageLoan') }}">
                            ...
                            <div class="col-span-12 md:col-span-6 mt-2">
                                <input class="font-light w-full leading-[1.15] placeholder:opacity-100 placeholder:text-body border border-primary border-opacity-60 rounded-[8px] p-[15px] focus:border-[#FD6400] focus:border-opacity-60 focus:outline-none focus:drop-shadow-[0px_6px_15px_rgba(0,0,0,0.1)] " type="text" placeholder="Full Name" name="ad_name" value="{!! $projects->title !!}" hidden required>
                            </div>
                            <div class="col-span-12 md:col-span-6 mt-2">
          ...
          <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div class="mt-2">
                    ...
                    <input type="text" placeholder="Project Type" name="ad_type" value="New Project" hidden  required>
