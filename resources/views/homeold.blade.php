            ...
            <div class="swiper mySwiper mt-[-9.5rem] swi" id="swi">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <section class="relative before:absolute before:inset-0 before:content-[''] ">
                        <div class="" id="bannerimages">
                            <img class="w-full min-h-[60px] md:min-h-[60px] object-cover" src="{{url('')}}/assets/images/hero/bg1.jpg" alt="hero image">
                ...
                <div class="swiper-slide">
                    <section class="relative before:absolute before:inset-0 before:content-[''] ">
                        <div class="" id="bannerimages">
                            <img class="w-full min-h-[60px] md:min-h-[60px] object-cover" src="{{url('')}}/assets/images/hero/bg2.jpg" alt="hero image">
                            <div class="absolute right-0 left-0 lg:top-[110px] xl:top-[155px] -translate-y-1/2 lg:translate-y-0">
                                <div class="container">
                                    <div class="grid grid-cols-12">
                                        <div class="col-span-12">
                ...
                <!--    <section class="relative before:absolute before:inset-0 before:content-[''] ">-->
                <!--        <div class="" id="bannerimages">-->
                <!--            <img class="w-full min-h-[60px] md:min-h-[60px] object-cover" src="{{url('')}}/assets/images/hero/bg3.jpg" alt="hero image">-->
                <!--            <div class="absolute right-0 left-0 lg:top-[110px] xl:top-[155px] -translate-y-1/2 lg:translate-y-0">-->
                <!--                <div class="container">-->
                <!--                    <div class="grid grid-cols-12">-->
                <!--                        <div class="col-span-12">-->
                ...
                <!--    <section class="relative before:absolute before:inset-0 before:content-[''] ">-->
                <!--        <div class="" id="bannerimages">-->
                <!--            <img class="w-full min-h-[60px] md:min-h-[60px] object-cover" src="{{url('')}}/assets/images/hero/bg4.jpg" alt="hero image">-->
                <!--            <div class="absolute right-0 left-0 lg:top-[110px] xl:top-[155px] -translate-y-1/2 lg:translate-y-0">-->
                <!--                <div class="container">-->
                <!--                    <div class="grid grid-cols-12">-->
                <!--                        <div class="col-span-12">-->
                    ...
                    <div class="col-span-12">
                        <div class="relative text-center mb-2">
                            <ul class="tab-nav search-tab inline-flex px-[5px] sm:px-[15px] pt-[15px] pb-[21px] border-t border-l border-r border-solid  rounded-tl-[20px] rounded-tr-[20px] rounded-bl-[20px] rounded-br-[20px] bg-[rgb(237,252,250,0.9)]" id="ul1">
                                ...
                                <a href="{{ route('sell') }}"><li class="md:mr-[0px] my-[-5px]"><button class="font-lora leading-none px-[2px] sm:px-[3px] capitalize text-primary transition-all text-base xl:text-[19px] before:absolute before:left-auto before:right-0 before:bottom-[-20px] before:z-10 before:rounded-full before:w-0 before:h-[3px] before:content-[''] before:bg-secondary relative before:transition-all ease-out" id="sell1">sell</button></a>
                                </li>
                            </ul>
                        ...
                        <div class="relative selectricc-border-none">
                                ...
                                <form action="{{ route('buy.search') }}" method="post">
                                    ...
                                    <div class="advanced-searrch flex flex-wrap -mb-[45px] lg:mr-[-2px]">
                                        <div class="advanced-searrch-list flex lg:border-r lg:border-primary lg:mr-[10px] xl:mr-[20px] last:mr-0 last:border-r-0 mb-[45px]" style="">
                                            ...
                                            <div class="flex-1">
                                                <label for="citybuy" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1">City</label>
                                        ...
                                        <div class="advanced-searrch-list flex lg:border-r lg:border-primary lg:mr-[10px] xl:mr-[20px] last:mr-0 last:border-r-0 mb-[45px]">
                                            ...
                                            <div class="flex-1">
                                                <label for="locationbuy" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1">Location</label>
                                        ...
                                        <div class="advanced-searrch-list flex lg:border-r lg:border-primary lg:mr-[10px] xl:mr-[20px] last:mr-0 last:border-r-0 mb-[45px]">
                                            ...
                                            <div class="flex-1">
                                                <label for="typebuy" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1">Property
                                                    Type</label>
                                        ...
                                        <div class="advanced-searrch-list flex lg:border-r lg:border-primary lg:mr-[10px] xl:mr-[20px] last:mr-0 last:border-r-0 mb-[45px]" style=" border:none; cursor: pointer;" >
                                            <div class="mr-4 self-start shrink-0">
                                                            ...
                                                            <div class="block" style=";" onclick="pricebuy()">
                                                                <label for="price" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1">Price Range</label>
                                    ...
                                    <div class="advanced-searrch-hidden flex flex-wrap items-center mt-[45px] -mb-[45px]">
                                        ...
                                        <div class="advanced-searrch-list flex lg:border-r lg:border-primary lg:mr-[10px] xl:mr-[20px] last:mr-0 last:border-r-0 mb-[45px] search-list">
                                            ...
                                            <div class="flex-1">
                                                <label for="bedroomsbuy" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1">Bedrooms</label>
                                        ...
                                        <div class="advanced-searrch-list border-r-black flex items-center lg:border-r lg:boprimaryborder-primaryD4D4] lg:mr-[10px] xl:mr-[20px] last:mr-0 last:border-r-0 mb-[45px] relative">
                                            ...
                                            <div class="flex-1">
                                                <label for="developerbuy" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1">Developers</label>
                                        ...
                                        <div class="advanced-searrch-list border-r-black flex items-center lg:border-r lg:boprimaryborder-primaryD4D4] lg:mr-[10px] xl:mr-[20px] last:mr-0 last:border-r-0 mb-[45px] relative" >
                                            ...
                                            <div class="flex-1">
                                                <label for="projectsbuy" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1">Projects</label>
                                        ...
                                        "  >
                                            ...
                                            <div class="block" style=";" onclick="morebuy()">
                                                <label for="garage" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1 show2" style="cursor: pointer" id="moreShow"  >More</label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form action="{{ route('rent.search') }}" method="post">
                                    ...
                                    <div class="advanced-searrch flex flex-wrap -mb-[45px] lg:mr-[-2px] mt-1">
                                        ...
                                        <div class="flex-1" style="display: -ms-flexbox; display: flex;  margin-bottom: 15px;">
                                                <!-- <label for="locationrent" class="font-lora block capitalize text-primary text-[20px] xl:text-[20px] leading-none mb-1">Search Location</label> -->
                                                <img src="{{url('')}}/assets/images/icon/search-grey.svg" class="w-[30px] h-[30px]" alt="search icon">
                                                <input id="locationrent" type="text" name="locationrent" placeholder="Search and select area" class="text-[18px] placeholder:text-body leading-none font-light pr-3 focus:outline-none w-full bg-transparent py-[0.5rem] ml-2" style="border-bottom: 1px solid; border-color: #787878;">
                                        </div>
                                        ...
                                        <div class="advanced-searrch-list flex lg:border-r lg:border-primary  last:border-r-0 mb-[45px] max-h-[2.5rem] mt-[1px]" style=" border:none; cursor: pointer;">
                                            ...
                                            <button class="search-btn py-auto absolute active right-[95px] w-[7rem] h-[3rem] font-lora capitalize text-base xl:text-[17px] rounded-bl-[20px] rounded-br-[20px] rounded-tr-[20px] rounded-tl-[20px] " style="color:black; padding:0px; color: white; letter-spacing: 1px;" id="b1view">
                                                <b>SEARCH</b>
                                                <!-- <img src="{{url('')}}/assets/images/icon/search-outline.svg" class="max-w-[20px] " width="30" height="30" alt="svg icon"> -->
                                            </button>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div id="co-living" class="tab-content bg-[rgb(237,252,250,0.9)] border border-solid rounded-bl-[15px] rounded-br-[15px] rounded-tr-[15px] px-[15px] sm:px-[30px] py-[28px] lg:max-h-56 overflow-visible">
                                <form action="{{route('projects.search')}}" method="post">
                                    ...
                                    <div class="advanced-searrch flex flex-wrap -mb-[45px] lg:mr-[-2px]">
                                        <div class="advanced-searrch-list flex lg:border-r lg:border-primary lg:mr-[10px] xl:mr-[20px] last:mr-0 last:border-r-0 mb-[45px]">
                                            ...
                                            <div class="flex-1">
                                                <label for="citynew" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1">City</label>
                                        ...
                                        <div class="advanced-searrch-list flex lg:border-r lg:border-primary lg:mr-[10px] xl:mr-[20px] last:mr-0 last:border-r-0 mb-[45px]">
                                            ...
                                            <div class="flex-1">
                                                <label for="locationnew" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1">Location</label>
                                        ...
                                        <div class="advanced-searrch-list flex lg:border-r lg:border-primary lg:mr-[10px] xl:mr-[20px] last:mr-0 last:border-r-0 mb-[45px]">
                                            ...
                                            <div class="flex-1">
                                                <label for="type" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1">Property
                                                    Type</label>
                                    ...
                                    <div class="advanced-searrch-hidden flex flex-wrap items-center mt-[45px] -mb-[45px]">
                                        ...
                                        <div class="advanced-searrch-list flex lg:border-r lg:border-primary lg:mr-[10px] xl:mr-[20px] last:mr-0 last:border-r-0 mb-[45px] search-list">
                                            ...
                                            <div class="flex-1">
                                                <label for="bedroomsnew" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1">Bedrooms</label>
                                        ...
                                        <div class="advanced-searrch-list border-r-black flex items-center lg:border-r lg:boprimaryborder-primaryD4D4] lg:mr-[10px] xl:mr-[20px] last:mr-0 last:border-r-0 mb-[45px] relative">
                                            ...
                                            <div class="flex-1">
                                                <label for="developernew" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1">Developers</label>
                                        ...
                                        <div class="advanced-searrch-list border-r-black flex items-center lg:border-r lg:boprimaryborder-primaryD4D4] lg:mr-[10px] xl:mr-[20px] last:mr-0 last:border-r-0 mb-[45px] relative" >
                                            ...
                                            <div class="flex-1">
                                                <label for="projectnew" class="font-lora block capitalize text-primary text-[18px] xl:text-[18px] leading-none mb-1">Projects</label>
                ...
                <div class="grid grid-cols-12">
                    <div class="col-span-12">
                        <div class="grid grid-cols-12">
                            <div class="col-span-12">
                                <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-[50px]">
                                    <div>
                                        <span class="text-secondary text-tiny inline-block " style="font-size: 18px; color: #D2AC47;">Best Choice</span>
                                    ...
                                    <div>
                                        <a href="/project" class="flex flex-wrap items-center text-secondary text-tiny" style="font-size: 18px">Explore all
                            ...
                            <div class="swiper -mx-[10px] -my-[30px] px-[10px] py-[30px] " id="swiper">
                                <div class="swiper-wrapper sm:rid-rows-none sm:grid-cols-none">
                                    ...
                                    <div class="swiper-slide text-center ">
                                        ...
                                        <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px] w-[100%]">
                        <div class="relative">
                        ...
                        <div class="py-[20px] px-[20px] text-left">
                            ...
                            <h4><a href="{{ route('property_details',$property->id) }}" class="font-light text-tiny underline" style=" margin-top: 20px">
                                @if($property->url != "")
                                    {{$property->url}}
                                @else
                                   UAE
                        ...
                        <div class="relative group">
                            <a href="/project" class="block group-hover:shadow-[0_10px_15px_0px_rgba(0,0,0,0.1)] transition-all duration-300">
                                 ...
                                 <div class="bg-[rgb(255,253,252,0.9)] rounded-[6px] px-[5px] py-[5px] absolute bottom-[15px] left-[25px] mb-25 right-[25px]">
                                        <span class="font-lora font-normal text-[23px] text-primary ">Dubai Marina</span>
                    ...
                    <div class="swiper-slide text-center area">
                        <div class="relative group">
                            <a href="/project" class="block group-hover:shadow-[0_10px_15px_0px_rgba(0,0,0,0.1)] transition-all duration-300">
                                ...
                                <div class="bg-[rgb(255,253,252,0.9)] rounded-[6px] px-[5px] py-[5px] absolute bottom-[15px] left-[25px] mb-25 right-[25px]">
                                        <span class="font-lora font-normal text-[23px] text-primary ">Emaar</span>
                                        <p class="font-light text-[18px] capitalize text-secondary "><b>Price From 600,000 AED</b></p>
                                 </div>
                            </a>
                        </div>
                    ...
                    <div class="swiper-slide text-center area">
                        <div class="relative group">
                            <a href="/project" class="block group-hover:shadow-[0_10px_15px_0px_rgba(0,0,0,0.1)] transition-all duration-300">
                                ...
                                <div class="bg-[rgb(255,253,252,0.9)] rounded-[6px] px-[5px] py-[5px] absolute bottom-[15px] left-[25px] mb-25 right-[25px]">
                                        <span class="font-lora font-normal text-[23px] text-primary ">Dubai Hills</span>
                                        <p class="font-light text-[18px] capitalize text-secondary "><b>Price From 600,000 AED</b></p>
                                 </div>
                            </a>
                        </div>
                    ...
                    <div class="swiper-slide text-center area">
                        <div class="relative group">
                            <a href="/project" class="block group-hover:shadow-[0_10px_15px_0px_rgba(0,0,0,0.1)] transition-all duration-300">
                                ...
                                <div class="bg-[rgb(255,253,252,0.9)] rounded-[6px] px-[5px] py-[5px] absolute bottom-[15px] left-[25px] mb-25 right-[25px]">
                                        <span class="font-lora font-normal text-[23px] text-primary ">Palm Jumeirah</span>
                                        <p class="font-light text-[18px] capitalize text-secondary "><b>Price From 600,000 AED</b></p>
                                 </div>
                            </a>
                        </div>
                    ...
                    <div class="swiper-slide text-center area">
                        <div class="relative group">
                            <a href="/project" class="block group-hover:shadow-[0_10px_15px_0px_rgba(0,0,0,0.1)] transition-all duration-300">
                                ...
                                <div class="bg-[rgb(255,253,252,0.9)] rounded-[6px] px-[5px] py-[5px] absolute bottom-[15px] left-[25px] mb-25 right-[25px]">
                                        <span class="font-lora font-normal text-[23px] text-primary ">Downtown Header</span>
                                        <p class="font-light text-[18px] capitalize text-secondary "><b>Price From 600,000 AED</b></p>
                                 </div>
                            </a>
                        </div>
                    ...
                    <div class="swiper-slide text-center area">
                        <div class="relative group">
                            <a href="/project" class="block group-hover:shadow-[0_10px_15px_0px_rgba(0,0,0,0.1)] transition-all duration-300">
                                ...
                                <div class="bg-[rgb(255,253,252,0.9)] rounded-[6px] px-[5px] py-[5px] absolute bottom-[15px] left-[25px] mb-25 right-[25px]">
                                        <span class="font-lora font-normal text-[23px] text-primary ">JBR</span>
                                        <p class="font-light text-[18px] capitalize text-secondary "><b>Price From 600,000 AED</b></p>
                                 </div>
                            </a>
                        </div>
            ...
            <div class="container">
                <div class="grid grid-cols-12 gap-6 items-center">
                    <div class="col-span-12 lg:col-span-6">
                        <span class="text-secondary text-tiny inline-block" style="font-size: 18px; color: #D2AC47;">Why Choose us</span>
                        <h2 class="font-lora text-primary text-[25px] sm:text-[25px] leading-[1.277] capitalize mb-5 lg:mb-16 font-medium max-w-[500px]">We Provide Latest Properties for our valuable Clients<span class="text-secondary">.</span></h2>
        ...
        <section class="blog-section relative mt-[50px]">
            <div class="container">
                <div class="">
                    <div class="">
                        <div class="mb-[60px] text-center">
                            <span class="text-secondary text-tiny inline-block" style="font-size: 18px; color: #D2AC47;">Our Blog</span>
                            <h2 class="font-lora text-primary text-[25px] sm:text-[25px] capitalize font-medium">
                        ...
                        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-[30px] mb-[-30px]">
                            ...
                            <div class="mb-[30px]">
                                ...
                                <div>
                                    ...
                                    <h3><a href="{{route('blog.post',$blogs->slug)}}" class="font-lora text-[18px] xl:text-[20px] leading-[1.285] text-primary block mb-[10px] hover:text-secondary transition-all font-medium">{{ $blogs->name }}</a></h3>
                                    <p class="font-light text-[#494949] text-[15px] leading-[1.75]">{{$blogs->short_description}}</p>
                                </div>
                            </div>
                            @endforeach
