...
</style>        <!-- News Letter section start -->
                    ...
                    <div class="col-span">
                        <div class="flex flex-wrap items-center justify-between py-[30px] xl:py-[40px] px-[30px] xl:px-[55px] shadow-[0px_10px_20px_rgba(196,196,196,0.5)] rounded-[15px] border border-[rgba(1,100,80,0.25)] bg-white mb-[80px] lg:mb-[-75px]">
                            <div class="w-full lg:w-auto">
                                <h3 class="font-lora text-primary text-[15px] sm:text-[15px] xl:text-[15px] leading-[1.277] mb-[10px]">Are you a Home Owner?</h3>
                                <p class="text-secondary leading-[1.5] tracking-[0.03em]" style="font-size: 16px; color: #D2AC47;">Put your email address and get listed.</p>
                            </div>
                            <div class="w-full lg:w-auto mt-5 lg:mt-0">
                                <form id="mc-form" action="#" class="relative w-full">
                                    <input id="mc-email" class="font-light text-primary leading-[1.75] opacity-100 border border-[#FF6500] w-full lg:w-[395px] xl:w-[495px] h-[60px] rounded-[10px] py-[15px] pl-[15px] pr-[15px] sm:pr-[135px] focus:border-primary focus:outline-none border-opacity-60 placeholder:text-primary text-sm" type="text" placeholder="Enter your email here...">
                                    <button id="mc-submit" type="submit" class="text-white font-medium text-[16px] leading-none tracking-[0.02em] bg-secondary py-[15px] px-[20px] mt-5 sm:mt-0 rounded-[10px] bg-[#D2AC47] hover:bg-primary transition-all sm:absolute sm:right-[5px] sm:top-1/2 sm:-translate-y-1/2 text-[13px]" style="">Get Listed</button>
                                </form>
...
<!-- Footer Start -->
        <footer class="footer bg-[#ECFAF7] pt-[80px] lg:pt-[200px] pb-30 md:pb-[80px] lg:pb-[110px] font-normal bg-no-repeat" style="background-image: url('{{url('')}}/assets/images/footer/pattern.png');">
            <div class="container">
                <div class="grid grid-cols-12 gap-x-[60px] mb-[-70px]">
                    <div class="col-span-12 sm:col-span-3 lg:col-span-3 mb-[30px]">
                        <a href="{{ route('home') }}" class="block mb-[25px]">
                            <img src="{{config('fgproperties.file_path').getSettings('site_logo_header')}}" style="width: 150px;" loading=lazy alt="Future Generation Properties">
                            <!-- <img src="{{URL('')}}/{{config('fgproperties.file_path').getSettings('site_logo_header')}}" style="width: 150px;" loading=lazy alt="Future Generation Properties"> -->
                        </a>
                        <p class="mb-[5px] xl:mb-[40px] max-w-[270px] text-sm">{{ getSettings('footer_about') }} </p>
                        
                    </div>
                    <div class="col-span-12 sm:col-span-3 lg:col-span-2 mb-[30px]">
                        <h3 class="font-lora font-normal text-[18px] leading-[1.222] text-primary mb-[20px] lg:mb-[30px]">
                            Quick Links<span class="text-secondary">.</span></h3>
                        <ul class="text-[16px] leading-none mb-[-20px]">
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="{{ route('buy') }}">Buy</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="{{ route('rent') }}">Rent</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="{{ route('sell') }}">Sell</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="{{ route('project') }}">Projects</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="{{ route('blog') }}">Blog</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="{{ route('careers') }}">Careers</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="{{ route('contactus') }}">Contact Us</a></li>
                        </ul>
                    </div>
                    <div class="col-span-12 sm:col-span-3 lg:col-span-2 mb-[30px]">
                        <h3 class="font-lora font-normal text-[18px] leading-[1.222] text-primary mb-[20px] lg:mb-[30px]">
                            Developers<span class="text-secondary">.</span></h3>
                        <ul class="text-[16px] leading-none mb-[-20px]">
                            @foreach($developers as $dev)
                            <!-- <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="#">Damac</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="#">Emaar</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="#">Sobha</a>
                            </li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="#">Arada</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="#">Nakheel</a></li> -->
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="{{ route('projects.developer',$dev->slug ) }}">{{$dev->developer_name}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="col-span-12 sm:col-span-3 lg:col-span-2 mb-[30px]">
                        ...
                        <ul class="text-[16px] leading-none mb-[-20px]">
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="#">Add Property</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="#">Our Agents</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="#">Terms & Conditions</a>
                            </li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="#">Privacy Policy</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="{{ route('about.us') }}">About Us</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary text-[15px]" href="#">Help Line</a></li>
                        </ul>
                    </div>
                    <div class="col-span-12 sm:col-span-3 lg:col-span-3 mb-[30px]">
                        <h3 class="font-lora font-normal text-[18px] leading-[1.222] text-primary mb-[20px] lg:mb-[30px]">
                            Address<span class="text-secondary">.</span></h3>
                        <p class="max-w-[270px] text-[15px]">{{ getSettings('address') }}</p>
                        <p class="mt-[10px] text-[15px]">{{ getSettings('contact_no_1') }} </p>
                        <p  class="mt-[10px] mb-[3rem] text-[15px]">{{ getSettings('website_email_1') }}</p>
                        ...
                        <!-- <p class="text-sm md:hidden mt-[20px]">&copy; <a href="#" class="text-secondary">FG Properties.</a> All Rights Reserved - Privacy Policy</p> -->
        ...
        <div class="font-lora text-white py-[11px]" style="background-color: #405463">
            <div class="container">
                <div class="grid md:grid-cols-2 ">
                    <div>
                        <span style="font-size: 17px; font-family: Karla, sans-serif;">&copy; <a href="#" class="">FG Properties.</a> All Rights Reserved - Privacy Policy</span>
                    </div>
                    <div style="font-family: Karla, sans-serif; font-size: 18px;">
        ...
        <a id="scrollUp" class="w-12 h-12 rounded-full bg-primary text-white fixed right-5 bottom-16 flex flex-wrap items-center justify-center transition-all duration-300 z-10" href="#" aria-label="scroll up">
            ...
            <svg width="25" height="25" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M6.101 261.899 25.9 281.698c4.686 4.686 12.284 4.686 16.971 0L198 126.568V468c0 6.627 5.373 12 12 12h28c6.627 0 12-5.373 12-12V126.568l155.13 155.13c4.686 4.686 12.284 4.686 16.971 0l19.799-19.799c4.686-4.686 4.686-12.284 0-16.971L232.485 35.515c-4.686-4.686-12.284-4.686-16.971 0L6.101 244.929c-4.687 4.686-4.687 12.284 0 16.97z"/></svg>
