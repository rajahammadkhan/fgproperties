            ...
            <div class="container">
                    ...
                    <div class="col-span-12">
                        <div class="col-span-12 mb-[70px]">
                            <div class="text-center">
                                <span class="text-secondary text-tiny inline-block mb-2" style="font-size: 18px; color: #D2AC47;">Contact us</span>
                                ...
                                <p class="mx-auto max-w-[465px] text-sm">
                ...
                <div class="grid col-span-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-[30px] mb-[-30px]">
                    ...
                    <div class="flex flex-wrap drop-shadow-[0px_16px_10px_rgba(0,0,0,0.1)] bg-[#F5F9F8] transition-all p-[20px] xl:p-[35px] rounded-[15px] mb-[30px]">
                        ...
                        <div class="flex-1">
                            <h4 class="font-lora leading-none text-[20px] sm:text-[20px] text-primary mb-[10px]">Address <span
                                    class="text-secondary">.</span></h4>
                            <p class="font-light text-[16px] lg:max-w-[230px]">{{ getSettings('address') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap drop-shadow-[0px_16px_10px_rgba(0,0,0,0.1)] bg-[#F5F9F8] transition-all p-[20px] xl:p-[35px] rounded-[15px] mb-[30px]">
                        ...
                        <div class="flex-1">
                            <h4 class="font-lora leading-none text-[20px] sm:text-[20px] text-primary mb-[10px]">Call us <span
                                    class="text-secondary">.</span></h4>
                                    <br>
                            <p class="font-light text-[16px] lg:max-w-[230px]">{{ getSettings('contact_no_1') }} </p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap drop-shadow-[0px_16px_10px_rgba(0,0,0,0.1)] bg-[#F5F9F8] transition-all p-[20px] xl:p-[35px] rounded-[15px] mb-[30px] xl:pl-[65px]">
                        ...
                        <div class="flex-1">
                            <h4 class="font-lora leading-none text-[20px] sm:text-[20px] text-primary mb-[10px]">Email us <span
                                    class="text-secondary">.</span></h4>
                                    <br>
                    ...
                    <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px] items-end">
                        <div class="col-span-12 lg:col-span-7 mb-[30px]">
                            <div>
                                ...
                                <p class="max-w-[465px] mb-[40px] text-sm">
                                    Huge number of propreties availabe here for buy, sell and Rent.
                                    Also you find here co-living property, lots opportunity
                                </p>
                        ...
                        <div class="col-span-12 lg:col-span-5 md:mb-[100px] order-last lg:order-none">
                            <div class="h-[385px] rounded-[15px] overflow-hidden xl:ml-[40px] max-h-[23.5rem]">
