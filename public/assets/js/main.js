...
function searchbut1() {
  document.getElementById("b1view").style.visibility = "visible";
  $("b1view").addClass("active");

}
// function searchbut2() {
//   document.getElementById("search-btn2").style.visibility = "visible";

// }
// function searchbut3() {
//   document.getElementById("search-btn3").style.visibility = "visible";
// }
  // search tab
 ...
 /*---------------------------------
    ...
    // document.querySelectorAll("#ul1").forEach(function (elment) {
    // elment.addEventListener("click", function () {
