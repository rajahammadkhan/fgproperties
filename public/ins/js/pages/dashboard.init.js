jQuery(function(e){
	...
	if(o.dashboardEcharts=function(){
		if(e("#platform_type_dates_donut").length){
			...
			options:[{
				color:['#020024', '#64c5b1', '#00d4ff', '#090979', '#45bbe0'],
				title:{
					text:"",
					subtext:""
				},
	...
	if(e("#user_type_bar").length){
		echarts.init(
			document.getElementById("user_type_bar")).setOption({
				grid:{
					zlevel:0,
					x:50,
					x2:50,
				...
				feature:{
					...
					magicType:{
						...
						xAxis:[{
							type:"category",
							boundaryGap:!1,
							data:["0h-2h","2h-4h","4h-6h","6h-8h","8h-10h","10h-12h","12h-14h","14h-16h","16h-18h","18h-20h","20h-22h","22h-24h"],
							axisLine:{show:!0,
								onZero:!0,
								lineStyle:{
									color:"#98a6ad",
